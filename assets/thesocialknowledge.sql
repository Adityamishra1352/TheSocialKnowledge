...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 29, 2023 at 11:35 AM
...
--
-- Table structure for table `c++course`
--

CREATE TABLE `c++course` (
...
--
-- Dumping data for table `c++course`
--

INSERT INTO `c++course` (`page_id`, `heading`, `description`, `code`) VALUES
...
(3, 'C++ Output', '<span>\r\n                The cout object, together with the << operator, is used to output values/print text:\r\n            <br></span>', '<section class=\"code\">#include <<x>iostream> <br>\r\n                using namespace std;<br>\r\n                \r\n                int main() {<br>\r\n                  cout << \"Hello World!\";<br>\r\n                  return 0;<br>\r\n                }<br>\r\n        <section>'),
...
INSERT INTO `users` (`user_id`, `fname`, `lname`, `email`, `password`, `admin`, `organiser`, `description`, `profileImage`, `location`) VALUES
(3, 'Aditya ', 'Mishra', '201b016@juetguna.in', '$2y$10$qoHKVMU/9Fd9JAHF7jDQDuRDZrkMZlDC7/rZmWksB7al047wpgOGq', 1, 0, '', '', ''),
(4, 'Aditi', 'Mishra', 'thesocialknowledge@gmail.com', '$2y$10$4/Lm0.2sV4Dch/Dpp8smz.ulihe1vL00XdxtWKZSVEUXexHPPLtRy', 0, 1, '', '', ''),
(7, 'Aditya ', 'Mishra', 'mishra.aditya0902@gmail.com', '$2y$10$kUXYB1iK1etxI952T.AHsuZ8FvQxpvyBU/FFEUc06EpaJlZwh4rUG', 0, 1, '', '', ''),
(8, 'Aditya ', 'Mishra', 'mishra.aditya1352@gmail.com', '$2y$10$PlvDZmFQ4YYVxObbd76EIOAdsvS0p8WWzDE.gJhCjx0cg.v6nEULO', 0, 0, 'Hii I am aditya', '../uploads/6516911dc1a528_IMG_20220430_141049_037.jpg', 'Allahabad, Uttar Pradesh'),
(9, 'Ayush', '', '201b082@juetguna.in', '$2y$10$bqE6sKAIDsHUZ4fg2JOCgu6RvKEcFSoOYYsEMBzZFnL94ffwo1BCO', 0, 0, '', '', ''),
(10, 'Tarushi', 'Agarwal', 'tarushi.aga2019@gmail.com', '$2y$10$bankpzEsoJBTpn1NjvrCSO2iVkIpP9b5wHbYXO009gbE2apylgKcy', 0, 0, '', '', '');
...
--
-- Indexes for table `c++course`
--
ALTER TABLE `c++course`
...
--
-- AUTO_INCREMENT for table `c++course`
--
ALTER TABLE `c++course`
...
--
ALTER TABLE `certificates`
  MODIFY `certificate_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;
